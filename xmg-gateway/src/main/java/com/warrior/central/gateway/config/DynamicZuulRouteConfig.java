...
import com.warrior.central.gateway.route.nacos.NacosDynRouteLocator;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "xmg.gateway.dynamicRoute", name = "enabled", havingValue = "true")
public class DynamicZuulRouteConfig {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "xmg.gateway.dynamicRoute", name = "dataType", havingValue = "nacos", matchIfMissing = true)
